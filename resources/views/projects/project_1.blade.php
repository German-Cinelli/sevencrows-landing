					...
					<div class="row pb-4 mb-2">
						<div class="col-md-6 mb-4 mb-md-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
							...
							<div class="owl-carousel owl-theme nav-inside nav-inside-edge nav-squared nav-with-transparency nav-dark mt-3" data-plugin-options="{'items': 1, 'margin': 10, 'loop': false, 'nav': true, 'dots': false}">
								...
								<div>
									<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">
										<img src="{{ asset('img/projects/project-sevenparts-2.png') }}" class="img-fluid border-radius-0" alt="">
									</div>
								</div>
								<div>
									<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">
										<img src="{{ asset('img/projects/project-sevenparts-3.png') }}" class="img-fluid border-radius-0" alt="">
									</div>
								</div>
                                <div>
									<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">
										<img src="{{ asset('img/projects/project-sevenparts-4.png') }}" class="img-fluid border-radius-0" alt="">
									</div>
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<p class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Nuestro último proyecto realizado hasta la fecha.</p>
                            <p class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Microempresa ubicada en Montevideo-Uruguay, dedicada a la venta de insumos informáticos y de equipos armados ambientados al gaming.</p>
							...
							<ul class="list list-icons list-primary list-borders text-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Cliente:</strong> SevenPartsUY</li>
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Fecha:</strong> Enero 2022</li>
								...
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Enlace:</strong> <a href="#" target="_blank" class="text-dark">http://sevenparts.uy/</a></li>
							</ul>
						</div>
					</div>
